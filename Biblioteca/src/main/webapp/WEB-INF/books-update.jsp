        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <form action="<%= request.getContextPath() %>/books/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="field_nome" value="<%= book.getNome() %>">
                </div>

                <div class="mb-3">
                    <label for="dataCriacao" class="form-label">Data de criacao: </label>
                    <input type="date" class="form-control" id="dataCriacao" name="field_dataCriacao" value="<%= book.getDataCriacao() %>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="field_autor" id="autor">
                        ...
                        <% for (Autor autor: autores) {%>
                            ...
                            <% String selected = (book.getAutor().getId() == autor.getId()) ? "selected" : ""; %>
                            <option <%= selected %> value="<%= autor.getId()%>"><%=autor.getNome() %></option>
